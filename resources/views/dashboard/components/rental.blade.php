            ...
            <table id="rentalTable" class="min-w-full bg-white border border-gray-200">
                <thead>
                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm">
                        ...
                        <th class="py-3 px-4 text-left">Booking Time</th>
...
<script>
                ...
                rentals.forEach((rental, index) => {
                    ...
                    const row = `
                        <tr>
                            ...
                            <td class="py-3 px-4 border-b">${rental.create_time_human}</td>
    ...
    async function updateStatus(rentalId) {
        ...
        let response = await axios.put(`{{ route('rent.update', '') }}/${rentalId}`, {
            status: status
        })
    ...
    function details(rental_id, start_date, end_date, total_cost, status, car_id, car_name, car_brand, car_model, car_year, car_rent_price, car_image) {
        modalOpen();
